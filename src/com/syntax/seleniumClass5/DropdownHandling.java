...
public class DropdownHandling {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        select.selectByIndex(3); // indexes starts from zero.

        select.selectByVisibleText("Thursday");

        Thread.sleep(1000);
        select.selectByValue("Sunday");
// whenever we interact with multiple elements you store them inside them
// container such as list,set etc..
        ...
        for(int i=0; i<size; i++){
            ...
            // how to click on each dropdown in a second?
